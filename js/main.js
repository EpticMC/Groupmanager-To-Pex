...
function fswitch(){
    ...
    if (gm2pex == true){
        ...
        $("#s-t-f").fadeOut("fast", function(){   $("#s-t-f").html("Switch the fields to \"PEX to GM\"").fadeIn("fast"); });
        $("#desc1").fadeOut("fast", function(){   $("#desc1").html("GroupManager to PermissionsEx").fadeIn("fast");      });
        $("#w-t-w").fadeOut("fast", function(){   $("#w-t-w").html("GM TO PEX").fadeIn("fast");                          });
        $("#title-l").fadeOut("fast", function(){ $("#title-l").html("Groupmanager to Pex Converter").fadeIn("middle");  });
        ...
        $("#s-t-f").fadeOut("fast", function(){   $("#s-t-f").html("Switch the fields to \"GM to PEX\"").fadeIn("fast"); });
        $("#desc1").fadeOut("fast", function(){   $("#desc1").html("PermissionsEx to GroupManager").fadeIn("fast");      });
        $("#w-t-w").fadeOut("fast", function(){   $("#w-t-w").html("PEX TO GM").fadeIn("fast");                          });
        $("#title-l").fadeOut("fast", function(){ $("#title-l").html("Pex to Groupmanager Converter").fadeIn("middle");  });
...
function fconvert(text){
    try {
        ...
        gm2pex ? convGmPex(text) : convPexGm(text);
    } 
    catch(e) {
